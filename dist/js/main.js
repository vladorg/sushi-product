...
window.onload = function () {
  ...
  checkout_tab_btn = getElem('.checkoutOrderCustomer__btn', false), checkout_tab = getElem('.checkoutOrderCustomer__form', false), customer_accept = getElem('#customer_accept'), customer_log = getElem('#customer_log');
  checkout_order = getElem('#checkout_order'), checkout_customer = getElem('.checkoutOrderCustomer'), checkout_customer_inner = getElem('.checkoutOrderCustomer__inner'), checkout_change = getElem('.checkoutOrder__change', false), checkout_form = getElem('.checkoutOrder'), checkout_customer_saved = getElem('.checkoutOrderCustomer .checkoutOrder__saved'), checkout_info = getElem('.checkoutOrderInfo'), checkout_info_trigger = getElem('.checkoutOrderInfo__defaultContent span'), checkout_info_radios = getElem('.checkoutOrderInfo input[type=radio]', false), checkout_city_pick = getElem('.checkoutOrderDelivery__cityAcc', false), checkout_new_address = getElem('.new_address', false);
    ...
    (function () {
        ...
        if (item) {
          item.addEventListener('click', function (e) {
            ...
            if (checkout_customer) {
              var _inputs_temp = checkout_customer.querySelectorAll('input');

              _inputs_temp.forEach(function (el) {
      ...
      if (checkout_order) {
        checkout_order.addEventListener('click', function (e) {
          ...
          if (checkout_info) {
            inputs_temp = checkout_info.querySelectorAll('input.required, textarea.required');
